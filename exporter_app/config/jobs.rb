{
  jobs: [
    WeekdayJob.new(:identifier => 'ead',
                   :description => 'Export EAD versions of FHL',
                   :days_of_week => ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
                   :start_time => '01:00',
                   :end_time => '23:59',
                   :minimum_seconds_between_runs => 10,
...
#                     ErbRenderer.new("templates/manifest.md.erb", "README.md"),
    ...
    WeekdayJob.new(:identifier => 'hc',
                   :description => 'Export EAD versions of Haverford repository',
                   :days_of_week => ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
                   :start_time => '01:00',
                   :end_time => '23:59',
                   :minimum_seconds_between_runs => 10,
...
#                     ErbRenderer.new("templates/manifest.md.erb", "README.md"),
    ...
    WeekdayJob.new(:identifier => 'bmc',
                   :description => 'Export EAD versions of BMC repository',
                   :days_of_week => ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
                   :start_time => '01:00',
                   :end_time => '23:59',
                   :minimum_seconds_between_runs => 10,
...
#                     ErbRenderer.new("templates/manifest.md.erb", "README.md"),
    ...
    WeekdayJob.new(:identifier => 'peace',
                   :description => 'Export EAD versions of Peace repository',
                   :days_of_week => ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
                   :start_time => '01:00',
                   :end_time => '23:59',
                   :minimum_seconds_between_runs => 10,
...
#                     ErbRenderer.new("templates/manifest.md.erb", "README.md"),
    ...
    WeekdayJob.new(:identifier => 'quaker',
                   :description => 'Export EAD versions of Quaker Meeting repo',
                   :days_of_week => ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'],
                   :start_time => '01:00',
                   :end_time => '23:59',
                   :minimum_seconds_between_runs => 10,
